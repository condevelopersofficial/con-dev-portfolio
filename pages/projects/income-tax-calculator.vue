...
const project = projectData.projects.items.find(item => item.title === "Income Tax Calculator")
    ...
    <div class="py-20">
          ...
          <div class="mt-6 p-6 bg-green-50 rounded-lg">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <ul class="text-gray-600 space-y-1">
                  <li>• 12 Tax Year Support</li>
                  <li>• Bulk Excel Processing</li>
                  <li>• Real-time Calculations</li>
                  <li>• Cross-year Comparisons</li>
      ...
      <div class="relative py-20 px-6 md:px-10 text-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden">
        ...
        <div class="relative z-10">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Need accurate tax calculations?</h2>
          <p class="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Contact us to learn how our Income Tax Calculator can simplify your financial compliance.</p>
