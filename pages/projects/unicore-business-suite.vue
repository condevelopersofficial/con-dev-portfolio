  ...
  <Container>
    <div class="py-20">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        ...
        <!-- Tags -->
        <div>
          <h2 class="text-3xl font-bold text-zinc-800 mb-6">Technologies</h2>
          <div class="flex flex-wrap gap-2">
            <span 
              v-for="tag in project.tags" 
              :key="tag"
              class="px-4 py-2 bg-blue-100 text-blue-800 text-sm rounded-full"
            >
              {{ tag }}
            </span>
          </div>
          ...
          <div class="mt-8 p-6 bg-gray-50 rounded-lg">
            <h3 class="text-xl font-semibold text-zinc-800 mb-3">Project Overview</h3>
          ...
          <div class="mt-6 p-6 bg-blue-50 rounded-lg">
            <h3 class="text-xl font-semibold text-zinc-800 mb-3">Technical Stack</h3>
            <div class="grid grid-cols-2 gap-4 text-sm">
              <div>
                <h4 class="font-semibold text-zinc-700 mb-2">Frontend</h4>
              ...
              <div>
                <h4 class="font-semibold text-zinc-700 mb-2">Backend</h4>
                <ul class="text-zinc-600 space-y-1">
      ...
      <div class="relative py-20 px-6 md:px-10 text-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden">
        ...
        <div class="relative z-10">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Interested in this solution?</h2>
          <p class="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Contact us to learn more about how {{ project.title }} can transform your operations.</p>
