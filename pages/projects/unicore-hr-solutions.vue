...
const project = projectData.projects.items.find(item => item.title === "UniCore HR Solutions")
    ...
    <div class="py-20">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <ul class="text-gray-600 space-y-1">
                  <li>• React 19 with Material-UI</li>
                  <li>• Recharts Analytics</li>
                  <li>• React Router DOM</li>
                  <li>• Excel Processing</li>
                  <li>• File Upload & Export</li>
                </ul>
              </div>
              <div>
      ...
      <div class="relative py-20 px-6 md:px-10 text-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl overflow-hidden">
        ...
        <div class="relative z-10">
          <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">Ready to optimize your HR processes?</h2>
          <p class="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">Contact us to discover how UniCore HR Solutions can transform your human resources management.</p>
